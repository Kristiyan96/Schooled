  ...
  describe "POST #create" do
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'new' template)" do
        post :create, params: {homework: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
  ...
  describe "PUT #update" do
    context "with valid params" do
      ...
      it "updates the requested homework" do
        homework = Homework.create! valid_attributes
        put :update, params: {id: homework.to_param, homework: new_attributes}, session: valid_session
        homework.reload
      ...
      it "redirects to the homework" do
        homework = Homework.create! valid_attributes
        put :update, params: {id: homework.to_param, homework: valid_attributes}, session: valid_session
    ...
    context "with invalid params" do
      it "returns a success response (i.e. to display the 'edit' template)" do
        homework = Homework.create! valid_attributes
        put :update, params: {id: homework.to_param, homework: invalid_attributes}, session: valid_session
        expect(response).to be_success
      end
    end
  end
